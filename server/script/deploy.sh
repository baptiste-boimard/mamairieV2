...
# sqitch deploy db:pg:mamairieV2 6.Add_reporting_category_in_DB
# sqitch deploy db:pg:mamairieV2 7.Add_reporting_in_DB
sqitch deploy db:pg:mamairieV2 8.Add_townhallstaff_in_DB