    ...
    <div className="reportAdmin">
      ...
      <div className="reportAdmin-header">
        <div className="reportAdmin-title">
          <h2>{report.title}</h2>
          <span className={`reportAdmin-statut reportAdmin-statut--${report.reporting_status.replace(' ', '_')}`}>{report.reporting_status}</span>
        </div>
      </div>
      <div className="reportAdmin-info">
        <h3>Coordonnées du signalant :</h3>
        <p className="reportAdmin-firstName">Prénom : {report.firstname}</p>
        <p className="reportAdmin-lastName">Nom : {report.lastname}</p>
